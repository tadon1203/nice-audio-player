...
export type BackendRequest = { method: "ping" } | { method: "getPlaybackState" } | { method: "getPlaybackQueue" } | { method: "pausePlayback" } | { method: "resumePlayback" } | { method: "previousPlayback" } | { method: "nextPlayback" } | { method: "seekPlayback"; params: {
	...
	sort_direction: LibrarySortDirection,
} } | { method: "getLibraryAlbumArtist"; params: {
	artist_key: LibraryAlbumArtistKey,
} } | { method: "listLibraryArtistAlbums"; params: {
	artist_key: LibraryAlbumArtistKey,
	after_cursor: string | null,
